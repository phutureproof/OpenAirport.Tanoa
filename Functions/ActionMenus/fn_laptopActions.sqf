...
_obj addAction ["<t color='#11c94e'>Laptop Menu</t>", {}, [], _menuPriority, true, true];
_obj addAction ["================", { }, [], _menuPriority, true, true];
_obj addAction ["<t color='#11c94e'>View Helicopter Jobs</t>", { [] call OA_fnc_viewHelicopterJobGUI; }, [], _menuPriority, true, true];
_obj addAction ["<t color='#11c94e'>View Plane Jobs</t>", { [] call OA_fnc_viewPlaneJobGUI; }, [], _menuPriority, true, true];
_obj addAction ["================", { }, [], _menuPriority, true, true];
